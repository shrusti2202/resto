...
<script src="{{ url('website/assets/vendor/purecounter/purecounter_vanilla.js')}}"></script>
...
<script src="{{ url('website/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js')}}"></script>
